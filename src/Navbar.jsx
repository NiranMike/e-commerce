  ...
  return (
    <>
      <div className=' backdrop-blur-md bg-[#fdfdfd98] h-[10vh] z-30 sticky top-0 left-0 right-0 shadow-md flex justify-around items-center'>
        <h1 className=' text-[#234872] ml-[-50px] font-bold text-[30px]'>Sneakers</h1>
        <div className=''>
        ...
        <div className="md:hidden sm:hidden mr-[-70px]" onClick={toggleBar}>
            {openMenu ? <img src={menu} width={"30px"} alt="" />: <img src={closeMenu} width={"30px"} alt="" />}
        </div>
      </div>
      <div className={!openMenu ? 'fixed z-40 left-0 top-0 w-[38%] md:w-[25%] h-full   bg-[#96bdf196] backdrop-blur-lg ease-in-out duration-700 px-0 py-[-40px] md:hidden  ' : ' z-40 fixed top-0 bottom-0 left-[-100%] ease-in-out duration-700'} >
          ...
          <ul className=' text-[#fff] m-0 mx-0 font-[500] w-[300px] '>
            <li className=' my-7 hover:cursor-pointer hover:text-[#000000] w-[183px] border-b hover:bg-[#5881af] font-medium h-9 px-2 py-1'>Home</li>
            <li className=' my-9 hover:cursor-pointer hover:text-[#000000] w-[183px] border-b hover:bg-[#5881af] font-medium h-9 px-2 py-1'>Contact</li>
            <li className=' my-9 hover:cursor-pointer hover:text-[#000000] w-[183px] border-b hover:bg-[#5881af] font-medium h-9 px-2 py-1'>About</li>
            <li className=' my-9 hover:cursor-pointer hover:text-[#05070a] w-[183px] border-b hover:bg-[#5881af] font-medium h-9 px-2 py-1'>Login</li>
          </ul>
      </div>
    </>
