...
import inspi4 from './images/new2.PNG'
  ...
  return (
    <div className='bg-white p-12 '>
        ...
        <div className=' mx-[20%] md:mx-auto grid md:grid-cols-2 lg:grid-cols-3'>
          ...
          <img src={inspi4} className=" ease-in-out hover:transition-transform hover:scale-105 duration-500 rounded-lg md:h-[39vh] lg:h-[45vh] h-[40vh] w-[400px] p-5" alt="" />
          ...
          <img src={inspi2} className=" ease-in-out hover:transition-transform hover:scale-105 duration-500 rounded-lg md:h-[39vh] lg:h-[45vh] h-[40vh] w-[400px] p-5" alt="" />
        </div>
    </div>
  )
}
